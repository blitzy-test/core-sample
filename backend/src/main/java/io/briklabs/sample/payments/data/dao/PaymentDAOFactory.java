...
/**
 * Factory class for creating and managing DAO instances with proper dependency injection.
 * <p>
 * This class centralizes the instantiation of payment DAO implementations, managing their
 * dependencies and lifecycle. It provides access to all payment DAOs through a unified
 * interface while hiding implementation details, enabling clean separation between data
 * access usage and implementation while supporting potential alternative implementations
 * or testing mocks.
 * </p>
 */
public interface PaymentDAOFactory {
    ...
    /**
     * Creates a new instance of the PaymentDAOFactory.
     * <p>
     * This method initializes the factory with the provided HikariDataSource,
     * which will be used by all DAO implementations for database connectivity.
     * </p>
     *
    ...
    static PaymentDAOFactory create(HikariDataSource dataSource) {
        return new io.briklabs.sample.payments.data.dao.impl.PaymentDAOFactoryImpl(dataSource);
    }

    /**
     * Creates a new instance of the PaymentDAOFactory with test mode enabled.
     * <p>
     * This method is intended for testing scenarios, allowing for the use of
     * mock implementations or specialized test configurations.
     * </p>
     *
     * @param dataSource The HikariDataSource to use for database connectivity
     * @param testMode Flag indicating whether to use test implementations
     * @return A new PaymentDAOFactory instance configured for testing
     */
    static PaymentDAOFactory create(HikariDataSource dataSource, boolean testMode) {
        return new io.briklabs.sample.payments.data.dao.impl.PaymentDAOFactoryImpl(dataSource, testMode);
    }
